...
#include "../headers/Notice.hpp"
#include "../headers/answer.hpp"
#include "../headers/tools.hpp"

int NOTICE(int poll_fd, Stock *Stock)
{
	int user_check[15];
	...
	if (Stock->line.size() < Stock->full_command["NOTICE"].size() ||
	Stock->line.size() > Stock->full_command["NOTICE"].size())
	{
